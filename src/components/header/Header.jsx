    ...
    <section className={styles.hero}>
      ...
      <div className={styles.area}>
        <div className={styles.name}>
          <h1>Leotrim Behrami</h1>
          <p>Full Stack Developer</p>
          <div className={styles.button}>About me</div>
        </div>

        <div className={styles.sozials}>
          <div>
